...
?>
	...
	<div id="bbp-single-user-details">
		...
		<div id="bbp-user-navigation">
			<ul>
				<li class="<?php if ( bbp_is_single_user_profile() ) :?>current<?php endif; ?> font-headlines">
				...
				<li class="<?php if ( bbp_is_single_user_topics() ) :?>current<?php endif; ?> font-headlines">
				...
				<li class="<?php if ( bbp_is_single_user_replies() ) :?>current<?php endif; ?> font-headlines">
				...
				<?php if ( bbp_is_favorites_active() ) : ?>
					<li class="<?php if ( bbp_is_favorites() ) :?>current<?php endif; ?> font-headlines">
				...
				<?php if ( bbp_is_user_home() || current_user_can( 'edit_users' ) ) : ?>
					...
					<?php if ( bbp_is_subscriptions_active() ) : ?>
						<li class="<?php if ( bbp_is_subscriptions() ) :?>current<?php endif; ?> font-headlines">
					...
					<li class="<?php if ( bbp_is_single_user_edit() ) :?>current<?php endif; ?> font-headlines">
